...
namespace CarsStorage.DAL.Migrations
{
    ...
    [Migration("20250303153113_AddDbStatesTable")]
    partial class AddDbStatesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarsStorage.DAL.Entities.DbStateEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DbStates", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1,
                            StateName = "Технические работы в настоящий момент",
                            Value = false
                        });
                });
